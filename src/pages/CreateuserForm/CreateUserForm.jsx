...
const CreateUserForm = () => {
  ...
  return (
    <><h2 className='w-full h-full  flex justify-center' style={{marginTop:45, fontSize:19, marginBottom:25}}>Registro</h2>
    <div className='container ' style={{ backgroundColor: "rgba(10, 150, 160, 0.2)", display: "flex", justifyContent: "center", alignItems: "center", marginLeft:'27%',padding:40, marginBottom:65 , width:700, borderRadius:10}}>
    ...
    <ul>
      ...
      <form onSubmit={addUser} >
        ...
        <button type="submit" className='w-full h-full  flex justify-center' style={{marginTop:25, fontSize:19,backgroundColor: "rgba(0, 0, 0, 0.2)", borderRadius:5, height:30}} >Registrarme!</button>
